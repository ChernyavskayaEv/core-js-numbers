...
function getAverage(value1, value2) {
  let result = 0;
  if (
    (value1 === Number.MAX_VALUE && value2 < 0) ||
    (value2 === Number.MAX_VALUE && value1 < 0)
  ) {
    result = (value1 + value2) / 2;
  } else if (value1 > value2) {
    result = value1 - (value1 - value2) / 2;
  } else {
    result = value2 - (value2 - value1) / 2;
  }
...
function getSumOfDigits(num) {
  return [...num.toString()].reduce((acc, item) => acc + Number(item), 0);
}
